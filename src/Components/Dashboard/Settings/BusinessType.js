                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="form-control w-full max-w-xs">
                            <input
                                ...
                                className={`input font-bold max-w-xs  focus:outline-0 rounded-sm border-gray-400 mt-1  w-full focus:border-blue-500  login-container-input ${errors.business && 'border-red-600 focus:border-red-600'}`}
                                {...register("business", {
                                    required: {
                                        value: true,
